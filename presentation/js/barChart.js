...
class BarChart {
    ...
    initVis() {
        ...
        vis.y = d3.scaleBand(d3.schemeCategory10).padding(0.1).range([vis.height, 0]);
    ...
    wrangleData() {
        ...
        vis.displayData.sort(
            (a, b) => (a.seasonalVisits[selectedSeason] - b.seasonalVisits[selectedSeason]) * popularFirst,
        );
    ...
    updateVis() {
        ...
        rectangles
            ...
            .on('mouseover', function (event, d) {
                ...
                d3.select(this).style('stroke', sharedYellow).style('stroke-width', 3);
            })
        ...
        // labels
        let labels = vis.svg.selectAll('.count').data(vis.displayData, (d) => d.id);
